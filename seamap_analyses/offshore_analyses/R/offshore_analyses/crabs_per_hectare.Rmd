...
seamap <- read_csv(#"~/Dropbox/SEAMAP_2019/data/offshore/seamap_cpue_2019.csv",
                   "~/Dropbox/csap_studies/seamap_analyses/data/GSMFC_processed/seamap_cpue_2019.csv",
                   guess_max = 1e6, 
                   col_types = cols())
...
szones <- read_sf("~/Dropbox/csap_studies/seamap_analyses/data/gis_files/NMFS_Fishing_Grids_GOM_2013.shp", 
                  crs = 4326)
...
write_csv(seamap, 
          "~/Dropbox/csap_studies/seamap_analyses/data/offshore/seamap_cpue_2019_analysis.csv", 
          col_names = TRUE)
...
season_summary %>% 
  select(Survey_Year, Season, Stations, `Missing Obs`, `% Occurrence`, `Mean Catch`, SD, Overdispersed) %>% 
  knitr::kable()
...
```{r data export}
write_csv(seamap, str_c("~/Dropbox/csap_studies/seamap_analyses/data/offshore/", 
                        "seamap_manuscriptmods_full.csv"), 
          col_names = TRUE)

write_csv(seamap_west, str_c("~/Dropbox/csap_studies/seamap_analyses/data/offshore/",
