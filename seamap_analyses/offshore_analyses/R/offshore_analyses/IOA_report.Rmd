...
seamap <- read_csv("~/Dropbox/csap_studies/seamap_analyses/data/offshore/seamap_cpue_2019.csv",
                   guess_max = 1e6, 
                   col_types = cols())
...
szones <- read_sf("~/Dropbox/csap_studies/seamap_analyses/data/gis_files/NMFS_Fishing_Grids_GOM_2013.shp", crs = 4326)
